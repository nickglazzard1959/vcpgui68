...
# This version works with 32 bit Ubuntu 14.04.
#
...
if [ -f /usr/local/lib/libSDL2.so ]; then
    ...
    g++ -O0 -g -Wall -DANCIENT -std=c++11 dsurf.cpp -o dsurf -I/usr/local/include/SDL2 -L/usr/local/lib \
        -lSDL2 -lSDL2_gfx -lSDL2_ttf -lSDL2_image -Wl,-rpath,/usr/local/lib
else
    echo "... using system SDL2."
    g++ -O0 -g -Wall -DANCIENT -std=c++11 dsurf.cpp -o dsurf -lSDL2 -lSDL2_gfx -lSDL2_ttf -lSDL2_image
fi
#
# SERIALIO,
echo "Build SERIALIO."
g++ -O0 -g -Wall -DANCIENT -std=c++11 -o serialio serialio.cpp
#
# TMCUSBIO.
echo "Build TMCUSBIO."
